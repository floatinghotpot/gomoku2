hotjs.i18n.put('zh', {
	...
	'info':'关于',
	'welcometogomoku':'哈罗！欢迎光临五子迷城！<br/><br/>忍者、卫兵、骑士、贵族与国王。<br/>他们的棋艺各有千秋。<br/><br/>开始您的奇幻之旅吧？<br/>您将获得 100 个金币作为见面礼！<br/>',
	'getgift':'领取 100 个金币',
	'tipon': '提示开启',
	...
	'ok':'确定',
	'cancel':'取消',
	'payment_supported' : '您可以用以下方式充值：',
	'select_payment' : '请选择充值方式：',
	'paypal' : 'PayPal',
	'iap' : 'Apple IAP',
	'paydone' : '充值成功',
	'paydone_happy' : '祝您游戏愉快！',
	'payfailed' : '充值失败',
	...
	'gametip_text' : '<ul><li>看广告，有惊喜。</li><li>手指可以缩放和移动网格。</li><li>15x15是标准棋盘。</li><li>5位对手的棋力和风格不同。</li><li>胜局奖金从 10 到 50 个金币不等。</li></ul>',
	'about_text' : '<p>安杰科技，智造乐趣</p><p>五子迷城, v2.0</p><p><br/></p><p>官方微博: @rnjsoft</p><p>邮箱: rnjsoft.mobile@gmail.com</p><p>官网: www.rnjsoft.com</p>'
});
