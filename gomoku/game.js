...
function showPlayerInfoDlg() {
	...
	dialog = hotjs.domUI.popupDialog( 
			...
			"<tr><td>" + hotjs.i18n.get('name') + "</td><td class='l'><input id='myname' value='"+ app_data.my.name + "'/></td>" + 
			"<tr><td>" + hotjs.i18n.get('email') + "</td><td class='l'><input id='myemail' value='"+ app_data.my.email + "'/></td>" + 
			"<tr><td>" + hotjs.i18n.get('twitter') + "</td><td class='l'><input id='mytwitter' value='"+ app_data.my.twitter + "'/></td>" + 
			"<tr><td>" + hotjs.i18n.get('facebook') + "</td><td class='l'><input id='myfacebook' value='"+ app_data.my.facebook + "'/></td>" + 
